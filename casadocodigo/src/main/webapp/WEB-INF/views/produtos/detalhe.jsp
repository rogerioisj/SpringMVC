	...
	<article id="livro-css-eficiente">
				...
				<ul id="variants" class="clearfix">
					<c:forEach items="${produto.precos }" var="preco">
						<li class="buy-option">
							...
							<label class="variant-label" >${precos.tipo }</label> 
		...
		<div class="container">
			...
			<section class="data product-detail">
				...
				<p></p>
				<p>Data de publicação: <span class="publisheAt"> <format:formatDate pattern="dd/MM/yyyy" value="${produto.dataLancamento.time }"/> </span></p>
				<p>
